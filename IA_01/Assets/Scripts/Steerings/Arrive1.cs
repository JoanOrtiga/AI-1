...
namespace Steerings
{
	...
	public class Arrive1 : SteeringBehaviour
	{
		...
		public  SteeringOutput GetSteering (GameObject target) {

			// no KS? get it
			if (this.ownKS==null) this.ownKS = GetComponent<KinematicState>();

			SteeringOutput result = Arrive1.GetSteeringTargeted (this.ownKS, this.target, this.closeEnoughRadius, 
				                                        this.slowDownRadius, this.timeToDesiredSpeed);
			base.applyRotationalPolicy (rotationalPolicy, result, target);
			return result;
		} 

		public static SteeringOutput GetSteeringTargeted (KinematicState ownKS, GameObject target, 
