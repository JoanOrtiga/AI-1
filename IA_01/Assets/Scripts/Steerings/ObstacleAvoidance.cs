...
namespace Steerings
{
	public class ObstacleAvoidance : SteeringBehaviour
	{
		...
		public static SteeringOutput GetSteering (KinematicState ownKS, bool showWhisker = true, 
			...
			if (showWhisker) {
				Debug.DrawRay (ownKS.position, whisker1Direction*lookAheadLength, Color.black);
				Debug.DrawRay (ownKS.position, whisker2Direction*lookAheadLength*secondaryWhiskerRatio, Color.black);
				Debug.DrawRay (ownKS.position, whisker3Direction*lookAheadLength*secondaryWhiskerRatio, Color.black);
			}
