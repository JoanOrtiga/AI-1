...
{
    public GameObject mouseAttractor;
    ...
    private void Awake()
    {
        ...
        {
            mouseAttractor = GameObject.FindObjectOfType<MouseAttractor>().gameObject;
            if(mouseAttractor == null)
            {
                Debug.LogError("No mouse attractor found");
            }
        }

        if (antSpawner == null)
        {
            antSpawner = GameObject.FindObjectOfType<AntSpawner>();
            if (antSpawner == null)
            {
